...
class ConvRenderBlock2d(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, mode='blur', deep=False, last_ch=3):
        super().__init__()
        self.mode = mode
        self.deep = deep
        ...
        self.toRGB = EqualConv2d(out_channel, last_ch, kernel_size=3, stride=1, padding=1, bias=True)
